...
local other_spitter_units = {"small-copper-biter", "medium-copper-biter", "behemoth-copper-biter", "leviathan-copper-biter"}
...
for _, unit_name in ipairs(other_spitter_units) do
	...
	data.raw["unit"][unit_name].attack_parameters.animation = table.deepcopy(data.raw["unit"]["big-copper-biter"].attack_parameters.animation)
end
...
for _, unit_name in ipairs(other_spitter_units) do
	data.raw["unit"][unit_name].attack_parameters.animation.layers[1].scale = data.raw["unit"][unit_name].run_animation.layers[1].scale
end
...
for _, unit_name in ipairs(other_spitter_units) do
	data.raw["unit"][unit_name].attack_parameters.animation.layers[2].tint = data.raw["unit"][unit_name].run_animation.layers[2].tint
end
